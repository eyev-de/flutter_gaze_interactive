...
class Keyboards {
  static List<List<Widget>> get(
    ...
    switch (keyboardState.type) {
      ...
      case KeyboardType.editor:
        switch (lang) {
          case Language.german:
            return _germanEditor(keyboardState);
          case Language.english:
            return _englishEditor(keyboardState);
        }
  ...
  static List<List<Widget>> _englishEditor(GazeKeyboardState keyboardState) {
    return [
      [
      ...
      [
        GazeKey(content: Icons.keyboard_capslock_rounded, type: GazeKeyType.caps, keyboardState: keyboardState), // widthRatio: 2
      ...
      if (!Platform.isIOS && !Platform.isAndroid)
        [
          GazeKey(content: 'ctrl', widthRatio: 1.5, type: GazeKeyType.ctrl, keyboardState: keyboardState),
          ...
          GazeKey(content: 'alt gr', widthRatio: 1.5, type: GazeKeyType.alt, keyboardState: keyboardState),
          if (Platform.isWindows) GazeKey(content: 'win', widthRatio: 1.2, type: GazeKeyType.win, keyboardState: keyboardState),
          GazeKey(content: 'ctrl', widthRatio: 1.5, type: GazeKeyType.ctrl, keyboardState: keyboardState),
        ]
    ];
  ...
  static List<List<Widget>> _germanEditor(GazeKeyboardState keyboardState) {
    return [
      [
        GazeKey(content: Icons.keyboard_tab_rounded, type: GazeKeyType.tab, keyboardState: keyboardState), // widthRatio: 1.7
        GazeKey(content: const ['°', '^'], keyboardState: keyboardState),
      ...
      [
        ...
        GazeKey(content: 'c', keyboardState: keyboardState),
        GazeKey(content: 'v', keyboardState: keyboardState),
        if (Platform.isIOS || Platform.isAndroid) GazeKey(content: ' ', widthRatio: 2, keyboardState: keyboardState),
        GazeKey(content: 'b', keyboardState: keyboardState),
        GazeKey(content: 'n', keyboardState: keyboardState),
        GazeKey(content: 'm', keyboardState: keyboardState),
        GazeKey(content: const [';', ','], keyboardState: keyboardState),
